...
var key=firebase.database().ref("To Do Data/" +key).push().key
var data=
{
    item:item.value,
    key:key
}
firebase.database().ref("To Do Data/" +key).set(data)
...
{
    firebase.database().ref("To Do Data").on('child_added',function(data)
    {
...
{
    firebase.database().ref("To Do Data/-MEms-iBo261DQDF5Hjt").remove()
}
removeFirebaseData()
